...
import { tool as snipTool } from './snip-tool';
...
import { tool as spinTheWheel } from './spin-the-wheel';
...
export const toolsByCategory: ToolCategory[] = [
  ...
  },
  {
    ...
    components: [qrCodeGenerator, wifiQrCodeGenerator, svgPlaceholderGenerator, cameraRecorder, snipTool],
  },
  {
    name: 'Development',
    components: [
  ...
  {
    name: 'Fun',
    components: [spinTheWheel],
  },
  {
    name: 'Prompts',
    components: [imagePrompts],
  },
  {
    name: 'Network',
    components: [
